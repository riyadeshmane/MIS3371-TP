...
function validateMinitial() {
    mini = document.getElementById("minitial").value;  // was "mini"
    var namePattern = /^[a-zA-Z]?$/; // allow empty (optional field)

    mini = mini.toUpperCase();
    document.getElementById("minitial").value = mini;  // was "mini"
